...
* [**Cask CDAP 4.1/4.2 for HDInsight**](hdinsight-install-published-app-cask.md) provides the first unified integration platform for big data that cuts down the time to production for data applications and data lakes by 80%. This application only supports Standard HBase 3.4 and 3.5 clusters.
