# Overview
## [What is Azure HDInsight?](hdinsight-tbd.md)
...
## [Choosing the VM size and type](hdinsight-tbd.md)
## [Choosing the cluster scale](hdinsight-tbd.md)
## [Commone problems](hdinsight-tbd.md)

# Configuring the Cluster
## [Creating Hive and Ooze databases](hdinsight-tbd.md)
## [Enabling Management with Ambari](hdinsight-tbd.md)
## [ARM Templates for 3rd party applications](hdinsight-tbd.md)
## [Authorize user acces to Ranger](hdinsight-tbd.md)
...
## [Monitoring with Ambari](hdinsight-tbd.md)
...
## [Use Script Actions to automate cluster setup](hdinsight-tbd.md)
...
## [Deep learning with Spark on HDInsight](hdinsight-tbd.md)

# Developing R scripts on HDInsight
## [ML and deep learning](hdinsight-tbd.md)
## [What is R Server?](hdinsight-tbd.md)
## [Configuring R Server on Spark](hdinsight-tbd.md)
## [Benefits of R Server on Spark vs. R Server on Hadoop](hdinsight-tbd.md)
## [Analyzing your R data from Azure Storage and Data Lake Store](hdinsight-tbd.md)
...
## [Connecting Spark Streaming and Structured Streaming Jobs to Kafka*](hdinsight-tbd.md)
## [Connecting Spark Streaming and Structured Streaming Jobs to EventHubs*](hdinsight-tbd.md)
## [Connecting Spark Streaming and Structured Streaming jobs to Power BI*](hdinsight-tbd.md)
